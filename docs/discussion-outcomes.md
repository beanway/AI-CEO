...
- 執行層 v2（2026-06-25）：終態為 AI 產出任務順序；現程式為固定 pipeline + 標記步驟。E1 先維護 repo 內 [`worker_default/`](../../worker_default/README.md) 預設 backend，fixture 測試通過後再接 `run-step`；見 [`design/execution-layer-v2.md`](design/execution-layer-v2.md)。
